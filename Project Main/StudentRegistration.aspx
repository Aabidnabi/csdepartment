...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        ...
        <div class="col-sm-10">
             <asp:TextBox placeholder="" ID="txt_dob" runat="server" class="form-control" TextMode="Date" required max="2010-12-31" min="1988-01-01"></asp:TextBox>
        </div>
        </div>
        ...
        <div class="col-sm-10">
             <asp:TextBox placeholder="Enter Your Enrollment Number" ID="txt_rollno" runat="server" class="form-control" required  MaxLength="12"></asp:TextBox>
        </div>
        </div>
       ...
       <div class="form-group"> <!--Degree-->
        ...
        <div class="col-sm-10 text-left">
         ...
         <asp:RadioButton ID="mtech" runat="server" groupname="degree" Text="Diploma"/>
