...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container-fluid" style="margin-top:15px">
        ...
        <div class="container-fluid row"><!--Image Autochange-->
                 <img src="images%20used/ssm11.jpg" class="myslide img-responsive img-thumbnail"/> 
                <img src="images%20used/ssm6.jpg" class="myslide img-responsive img-thumbnail"/>
                <img src="images%20used/ssm7.jpg" class="myslide img-responsive img-thumbnail"/> 
                <img src="images%20used/ssm15.png" class="myslide img-responsive img-thumbnail"/>
                <img src="images%20used/ssm14.jpg" class="myslide img-responsive img-thumbnail"/>
                <img src="images%20used/ssm8.jpg" class="myslide img-responsive img-thumbnail"/> 
